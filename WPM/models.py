...
"""
    ...
    2. Ustaw różne opcje praw dostępu dla poszczególnych modeli -
       tak, aby były w miarę sensowne
    3. Przy dodawaniu rekordów do modeli z właścicielem -
       ustaw automatycznie właściciela jako użytkownika, który dany rekord stworzył
